...
:mediaFiles
	echo This only checks the current user's documents, music, pictures, vdieos, and 3d objects folders.
	pause
	
	#Checks Documents
	dir C:\users\%username%\Documents /OE
	echo
	echo

	#Checks Music
	dir C:\users\%username%\Music /OE
	echo
	echo

	#Checks Pictures
	dir C:\users\%username%\Pictures /OE
	echo
	echo

	#Checks Videos
	dir C:\users\%username%\Videos /OE
	echo
	echo

	#Checks 3D Objects
	dir C:\users\%username%\"3D Objects" /OE
	echo
	echo
